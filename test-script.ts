...
console.log(
  `Decrypted: ${CipherVault.decrypt(result1.encrypted, result1.key)}`
);
console.log(
  `Match: ${
    CipherVault.decrypt(result1.encrypted, result1.key) === text1 ? "✅" : "❌"
  }\n`
);
...
console.log(
  `Decrypted: ${CipherVault.decryptWithPassword(result2.encrypted, password)}`
);
console.log(
  `Match: ${
    CipherVault.decryptWithPassword(result2.encrypted, password) === text2
      ? "✅"
      : "❌"
  }\n`
);
...
console.log(
  `Results match: ${result3a.encrypted === result3b.encrypted ? "✅" : "❌"}\n`
);
